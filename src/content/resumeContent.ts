export const resumeContent = {
	...
	mainText:
		"Product driven software engineer with 3+ years of professional experience. Well-versed in modern technology and engineering best practices with a strong background in computer science and mathematics. Loves to work as part of a team and participate in discussions. Well-rounded and professional team player dedicated to continued learning and development.",
	employment: [
		{
	...
	references: [
		{
			title: "Scott Velazquez, Greater Bank",
			timePeriod: "Head of delivery",
			listItems: ["0432322311"],
		},
